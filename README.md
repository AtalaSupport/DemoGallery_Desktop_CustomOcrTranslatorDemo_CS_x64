...
Demonstrates how to create and use a custom OCR translator. In this example, the translator implemented here will convert regular text to [pig latin](https://www.wikihow.com/Speak-Pig-Latin).
